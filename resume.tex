...
\textsc{May} 2017& Undergraduate Degree in \textsc{Computer Engineering} \\
(Anticipated) & \normalsize\textbf{University of Michigan (U of M)}, Ann Arbor \\
...
\begin{tabular}{rl}
\textsc{Intermediate Knowledge:} & C++, Matlab, \LaTeX  \\
\textsc{Basic Knowledge:} & Git, OpenCV \\
\end{tabular}
